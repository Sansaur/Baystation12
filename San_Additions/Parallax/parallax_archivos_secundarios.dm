...
esto va en turf/space/space.dm
se pone si se cambia
Lo cambiado fue de "icon_state" = "formula rara"
A "white"
...
// Añadiendo esto para PARALLAX
// Dios mio, cuanta cosa, ploooox - Sansaur
// Lo he COMENTADO porque supuestamente no hace falta.
/*
#define LIST_FAST 1
#define LIST_NORM 2
#define LIST_SLOW 3
